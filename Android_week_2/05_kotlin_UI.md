...
액티비티의 구성요소가 엄청 많다면, 하나의 액티비티에서 많은 구성요소를 다 관리해야 합니다.   
액티비티 코드가 복잡해질 수 있습니다. 그럼 관리가 어려워져 권장하지 않습니다.

> <h3>다양한 디바이스에서 오는 문제</h3>

안드로이드에는 핸드폰만 있는 것이 아니라 비율이 아예 다른 태블릿이 있습니다.   
